    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        {[
          ...
          ['Partenaires actifs',(dataSource.counters as DashboardData['counters'] & { partners?: number }).partners?.toLocaleString('fr-FR') ?? dataSource.counters.clients.toLocaleString('fr-FR'),'+8%',UserRound,'text-info bg-info/10'],
